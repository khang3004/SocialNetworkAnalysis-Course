...
def main():
    # Download và đọc dữ liệu từ SNAP
    print("Downloading and reading data from SNAP...")
    ...
    print(f"  Max: {metrics['degree_centrality']['max']:.4f}")
    print(f"  Average: {metrics['degree_centrality']['avg']:.4f}")
    print(f"  Node with highest degree centrality: {metrics['degree_centrality']['node_max']}")
